...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-50 to-white px-6 pt-24"
    ...
    >
      ...
      >
        A passionate MERN Stack Developer crafting modern web applications with
